...
def fetch_poster(m_id):
    url = 'https://api.themoviedb.org/3/movie/{}?api_key=3163f88e8f7d409c0a6d0fa2fcebe51b&language=en-US'.format(m_id)
...
movies = pickle.load(open(r'model\movies_list.pkl','rb'))
